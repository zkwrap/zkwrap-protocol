...
const Hero = () => {
      const {initializeContract, address} = useZkContext()
        ...
        <div className='flex h-[80%] w-[90%] my-auto mx-auto flex-col items-start justify-between'>
            <div className='flex w-full justify-between mt-[20px] items-center'> 
                ...
                <div>
                    ...
                    {/* <CustomButton clickHandler={connectingWallet} title="Connect Wallet" /> */}
                </div>
             </div>
            ...
            <div className='flex flex-col gap-[30px]'> 
              ...
              <div className='flex md:w-[400px] w-[330px] md:mt-[30px] mt-[20px] items-center justify-between'>
                    ...
                    <CustomButton disabled={`${claimed ? true : false}`} clickHandler={claimWhitelist} title={`${claimed ? "Already Joined" : "Join Whitelists"}`} styles="md:h-[50px] h-[40px] uppercase font-bold whitespace-nowrap text-[14px] " />
              </div>
