...
contract ZKWrap is ERC20 {
    ...
    address _feereceiever1, 
    address _feereceiever2 , 
    uint256 feea , uint256 feeb, 
    uint256 feec , uint256 maxTxPercent , 
    uint256 supply , uint256 maxWalletLimit) ERC20(_name, _symbol, supply * 1e18) {
    ...
    /**
     * @dev check whether swap is locked or not
     * @param boolean 
     * @return boolean
     */
